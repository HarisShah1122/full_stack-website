...
>>>>>>> d8f4eb17f8f8696e5f0fa5d615cc725b58a1c61c
      ...
      {isTopBarVisible && (
        <div className="flex justify-center items-center gap-2 bg-pink-600 text-white text-sm font-medium py-2">
          <span className="hidden sm:inline">
            🌍 Flat shipping rate of 200 available for Mardan
          </span>
...
<<<<<<< HEAD
            <Link
              to="/"
              className="text-sm font-medium uppercase text-gray-800 hover:text-blue-600 hover:underline"
            >
              Shop By Category
            </Link>
            <Link
...
>>>>>>> d8f4eb17f8f8696e5f0fa5d615cc725b58a1c61c
            ...
            <Link
              to="/cart"
              className="text-sm font-medium uppercase text-gray-800 hover:text-blue-600 hover:underline relative"
            >
...
<<<<<<< HEAD
              <Link
                to="/"
                className="text-sm font-medium uppercase text-gray-800 hover:text-blue-600 hover:underline text-center"
                onClick={toggleMobileMenu}
              >
                Shop By Category
              </Link>
              ...
              <Link
                to="/cart"
                className="text-sm font-medium uppercase text-gray-800 hover:text-blue-600 hover:underline text-center relative"
                onClick={toggleMobileMenu}
              >
